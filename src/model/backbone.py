...
from .attn import MixedConvAttModuleV2, MixedConvAttModule, SingleStageModel
...
class EncoderModel(nn.Module):
    def __init__(self, num_layers, num_f_maps, input_dim, num_classes, kernel_size,
        ...
        self.encoder = SingleStageModel(num_layers, num_f_maps, kernel_size, normal_dropout_rate)
